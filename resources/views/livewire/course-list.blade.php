                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" wire:click="getCourseDetails({{ $course->id }})"
                                    data-bs-toggle="modal" data-bs-target="#EditCourseModel" class="btn btn-warning"><i
                                        class="bi bi-pen-fill"></i></button>
                                <button type="button" wire:click="DeleteCourse({{ $course->id }})"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="row g-3" wire:submit.prevent="EditCourse">
                                <div class="col-md-6">
                                    <input type="text" wire:model="name" class="form-control"
                                        placeholder="Course Nam">
                                </div>
                                <div class="col-md-6">
                                    <input type="integer" wire:model="duration" class="form-control"
