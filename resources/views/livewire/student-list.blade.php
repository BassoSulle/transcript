                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-8">
                            <input type="file" wire:model="passport_size" class="form-control" placeholder="Upload your passport">
                            @error('name')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" wire:click="getStudentDetails({{$student->id}})"
                            data-bs-toggle="modal" data-bs-target="#EditStudentModel"
                            class="btn btn-warning"><i class="bi bi-pen-fill"></i></button>
                        <button type="button" id="student_id" wire:click="DeleteStudent({{$student->id}})" class="btn btn-danger"><i class="bi bi-trash-fill"></i></button>
                    </td>
                </tr>
            @empty
                <tr>
